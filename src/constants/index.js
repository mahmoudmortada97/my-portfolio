...
const projects = [
    ...
    //     description:
    //         "A web application to allow users to customize a 3D model of a shirt, using React, threeJS and framermotion to construct the front-end, using expressJS and the openAI API to create the backend which allows the user to generate images using a text prompt that could be displayed on the shirt.",
    //     tags: [
    //         {
    //             name: "NodeJS",
    //         },
    ...
    //     source_code_link:
    //         "https://github.com/elmotasembelah/FullStack-Threejs-AI",
